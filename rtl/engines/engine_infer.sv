...
//
// Candidate 0: inferred arithmetic.
//
// TILE_M x TILE_N dot product units described with `*` and `+`, so Yosys and ABC
// choose the multiplier and adder structure. Single cycle: the tile product is
// absorbed by the accumulator on the launch edge and valid_o rises the cycle
// after.
//
