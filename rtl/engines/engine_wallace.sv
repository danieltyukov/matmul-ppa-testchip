...
//
// Candidate 1: Wallace tree MAC.
//
// TILE_M x TILE_N dot product units, each built from explicit signed partial
// products reduced by a 3:2 carry-save tree (see dot_wallace.sv and
// csa_reduce.sv). Nothing is left to multiplier inference. Single cycle, same
// timing contract as candidate 0.
//
